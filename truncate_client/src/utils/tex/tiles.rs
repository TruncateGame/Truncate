...
pub const SKIP_NEXT_BUTTON_NW: Tex = t(197);
pub const SKIP_NEXT_BUTTON_NE: Tex = t(198);
pub const SKIP_NEXT_BUTTON_SW: Tex = t(199);
pub const SKIP_NEXT_BUTTON_SE: Tex = t(200);
pub const TRI_NORTH_BUTTON_NW: Tex = t(201);
pub const TRI_NORTH_BUTTON_NE: Tex = t(202);
pub const TRI_NORTH_BUTTON_SW: Tex = t(203);
pub const TRI_NORTH_BUTTON_SE: Tex = t(204);
pub const TRI_SOUTH_BUTTON_NW: Tex = t(205);
pub const TRI_SOUTH_BUTTON_NE: Tex = t(206);
pub const TRI_SOUTH_BUTTON_SW: Tex = t(207);
pub const TRI_SOUTH_BUTTON_SE: Tex = t(208);
pub const SKIP_PREV_BUTTON_NW: Tex = t(209);
