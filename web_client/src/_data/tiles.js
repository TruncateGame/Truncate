const tiles = {
    ...
    WHEAT_WIND_1: 69,
    WELL: 70,
    NORTH_ARTIFACT_NW: 71,
    NORTH_ARTIFACT_NE: 72,
    NORTH_ARTIFACT_SW: 73,
    NORTH_ARTIFACT_SE: 74,
    NORTH_ARTIFACT_SAIL_WIND_0_NW: 75,
    NORTH_ARTIFACT_SAIL_WIND_0_NE: 76,
    NORTH_ARTIFACT_SAIL_WIND_1_NW: 77,
    NORTH_ARTIFACT_SAIL_WIND_1_NE: 78,
    NORTH_ARTIFACT_SAIL_WIND_2_NW: 79,
    NORTH_ARTIFACT_SAIL_WIND_2_NE: 80,
    SOUTH_ARTIFACT_NW: 81,
    SOUTH_ARTIFACT_NE: 82,
    SOUTH_ARTIFACT_SW: 83,
    SOUTH_ARTIFACT_SE: 84,
    SOUTH_ARTIFACT_SAIL_WIND_0_NW: 85,
    SOUTH_ARTIFACT_SAIL_WIND_0_SW: 86,
    SOUTH_ARTIFACT_SAIL_WIND_1_NW: 87,
    SOUTH_ARTIFACT_SAIL_WIND_1_SW: 88,
    SOUTH_ARTIFACT_SAIL_WIND_2_NW: 89,
    SOUTH_ARTIFACT_SAIL_WIND_2_SW: 90,
    EAST_ARTIFACT_NW: 91,
    EAST_ARTIFACT_NE: 92,
    EAST_ARTIFACT_SW: 93,
    EAST_ARTIFACT_SE: 94,
    EAST_ARTIFACT_SAIL_WIND_0_NW: 95,
    EAST_ARTIFACT_SAIL_WIND_0_NE: 96,
    EAST_ARTIFACT_SAIL_WIND_0_SW: 97,
    EAST_ARTIFACT_SAIL_WIND_0_SE: 98,
    EAST_ARTIFACT_SAIL_WIND_1_NW: 99,
    EAST_ARTIFACT_SAIL_WIND_1_NE: 100,
    EAST_ARTIFACT_SAIL_WIND_1_SW: 101,
    EAST_ARTIFACT_SAIL_WIND_1_SE: 102,
    EAST_ARTIFACT_SAIL_WIND_2_NW: 103,
    EAST_ARTIFACT_SAIL_WIND_2_NE: 104,
    EAST_ARTIFACT_SAIL_WIND_2_SW: 105,
    EAST_ARTIFACT_SAIL_WIND_2_SE: 106,
    WEST_ARTIFACT_NW: 107,
    WEST_ARTIFACT_NE: 108,
    WEST_ARTIFACT_SW: 109,
    WEST_ARTIFACT_SE: 110,
    WEST_ARTIFACT_SAIL_WIND_0_NW: 111,
    WEST_ARTIFACT_SAIL_WIND_0_NE: 112,
    WEST_ARTIFACT_SAIL_WIND_1_NW: 113,
    WEST_ARTIFACT_SAIL_WIND_1_NE: 114,
    WEST_ARTIFACT_SAIL_WIND_2_NW: 115,
    WEST_ARTIFACT_SAIL_WIND_2_NE: 116,
    FLOATING_ARTIFACT_NW: 117,
    FLOATING_ARTIFACT_NE: 118,
    FLOATING_ARTIFACT_SW: 119,
    FLOATING_ARTIFACT_SE: 120,
    FLOATING_ARTIFACT_SAIL_WIND_0_NW: 121,
    FLOATING_ARTIFACT_SAIL_WIND_0_NE: 122,
    FLOATING_ARTIFACT_SAIL_WIND_1_NW: 123,
    FLOATING_ARTIFACT_SAIL_WIND_1_NE: 124,
    FLOATING_ARTIFACT_SAIL_WIND_2_NW: 125,
    FLOATING_ARTIFACT_SAIL_WIND_2_NE: 126,
    GAME_PIECE_NW: 127,
    GAME_PIECE_NE: 128,
    GAME_PIECE_SW: 129,
    GAME_PIECE_SE: 130,
    ...
    ARTIFACT_BUTTON_NW: 239,
    ARTIFACT_BUTTON_NE: 240,
    ARTIFACT_BUTTON_SW: 241,
    ARTIFACT_BUTTON_SE: 242,
    ARTIFACT_BUTTON_SAIL_NW: 243,
    ARTIFACT_BUTTON_SAIL_NE: 244,
...
const quads = {
    ...
    NORTH_ARTIFACT: [[tiles.NORTH_ARTIFACT_NW, tiles.NORTH_ARTIFACT_NE],[tiles.NORTH_ARTIFACT_SW, tiles.NORTH_ARTIFACT_SE]],
    NORTH_ARTIFACT_SAIL_WIND_0: [[tiles.NORTH_ARTIFACT_SAIL_WIND_0_NW, tiles.NORTH_ARTIFACT_SAIL_WIND_0_NE],[tiles.NONE, tiles.NONE]],
    NORTH_ARTIFACT_SAIL_WIND_1: [[tiles.NORTH_ARTIFACT_SAIL_WIND_1_NW, tiles.NORTH_ARTIFACT_SAIL_WIND_1_NE],[tiles.NONE, tiles.NONE]],
    NORTH_ARTIFACT_SAIL_WIND_2: [[tiles.NORTH_ARTIFACT_SAIL_WIND_2_NW, tiles.NORTH_ARTIFACT_SAIL_WIND_2_NE],[tiles.NONE, tiles.NONE]],
    SOUTH_ARTIFACT: [[tiles.SOUTH_ARTIFACT_NW, tiles.SOUTH_ARTIFACT_NE],[tiles.SOUTH_ARTIFACT_SW, tiles.SOUTH_ARTIFACT_SE]],
    SOUTH_ARTIFACT_SAIL_WIND_0: [[tiles.SOUTH_ARTIFACT_SAIL_WIND_0_NW, tiles.NONE],[tiles.SOUTH_ARTIFACT_SAIL_WIND_0_SW, tiles.NONE]],
    SOUTH_ARTIFACT_SAIL_WIND_1: [[tiles.SOUTH_ARTIFACT_SAIL_WIND_1_NW, tiles.NONE],[tiles.SOUTH_ARTIFACT_SAIL_WIND_1_SW, tiles.NONE]],
    SOUTH_ARTIFACT_SAIL_WIND_2: [[tiles.SOUTH_ARTIFACT_SAIL_WIND_2_NW, tiles.NONE],[tiles.SOUTH_ARTIFACT_SAIL_WIND_2_SW, tiles.NONE]],
    EAST_ARTIFACT: [[tiles.EAST_ARTIFACT_NW, tiles.EAST_ARTIFACT_NE],[tiles.EAST_ARTIFACT_SW, tiles.EAST_ARTIFACT_SE]],
    EAST_ARTIFACT_SAIL_WIND_0: [[tiles.EAST_ARTIFACT_SAIL_WIND_0_NW, tiles.EAST_ARTIFACT_SAIL_WIND_0_NE],[tiles.EAST_ARTIFACT_SAIL_WIND_0_SW, tiles.EAST_ARTIFACT_SAIL_WIND_0_SE]],
    EAST_ARTIFACT_SAIL_WIND_1: [[tiles.EAST_ARTIFACT_SAIL_WIND_1_NW, tiles.EAST_ARTIFACT_SAIL_WIND_1_NE],[tiles.EAST_ARTIFACT_SAIL_WIND_1_SW, tiles.EAST_ARTIFACT_SAIL_WIND_1_SE]],
    EAST_ARTIFACT_SAIL_WIND_2: [[tiles.EAST_ARTIFACT_SAIL_WIND_2_NW, tiles.EAST_ARTIFACT_SAIL_WIND_2_NE],[tiles.EAST_ARTIFACT_SAIL_WIND_2_SW, tiles.EAST_ARTIFACT_SAIL_WIND_2_SE]],
    WEST_ARTIFACT: [[tiles.WEST_ARTIFACT_NW, tiles.WEST_ARTIFACT_NE],[tiles.WEST_ARTIFACT_SW, tiles.WEST_ARTIFACT_SE]],
    WEST_ARTIFACT_SAIL_WIND_0: [[tiles.WEST_ARTIFACT_SAIL_WIND_0_NW, tiles.WEST_ARTIFACT_SAIL_WIND_0_NE],[tiles.NONE, tiles.NONE]],
    WEST_ARTIFACT_SAIL_WIND_1: [[tiles.WEST_ARTIFACT_SAIL_WIND_1_NW, tiles.WEST_ARTIFACT_SAIL_WIND_1_NE],[tiles.NONE, tiles.NONE]],
    WEST_ARTIFACT_SAIL_WIND_2: [[tiles.WEST_ARTIFACT_SAIL_WIND_2_NW, tiles.WEST_ARTIFACT_SAIL_WIND_2_NE],[tiles.NONE, tiles.NONE]],
    FLOATING_ARTIFACT: [[tiles.FLOATING_ARTIFACT_NW, tiles.FLOATING_ARTIFACT_NE],[tiles.FLOATING_ARTIFACT_SW, tiles.FLOATING_ARTIFACT_SE]],
    FLOATING_ARTIFACT_SAIL_WIND_0: [[tiles.FLOATING_ARTIFACT_SAIL_WIND_0_NW, tiles.FLOATING_ARTIFACT_SAIL_WIND_0_NE],[tiles.NONE, tiles.NONE]],
    FLOATING_ARTIFACT_SAIL_WIND_1: [[tiles.FLOATING_ARTIFACT_SAIL_WIND_1_NW, tiles.FLOATING_ARTIFACT_SAIL_WIND_1_NE],[tiles.NONE, tiles.NONE]],
    FLOATING_ARTIFACT_SAIL_WIND_2: [[tiles.FLOATING_ARTIFACT_SAIL_WIND_2_NW, tiles.FLOATING_ARTIFACT_SAIL_WIND_2_NE],[tiles.NONE, tiles.NONE]],
    ...
    ARTIFACT_BUTTON_SAIL: [[tiles.ARTIFACT_BUTTON_SAIL_NW, tiles.ARTIFACT_BUTTON_SAIL_NE],[tiles.NONE, tiles.NONE]],
